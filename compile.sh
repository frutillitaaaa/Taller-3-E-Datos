...
g++ -Iheader -c source/Cliente.cpp -o Cliente.o
...
# Enlazar los objetos
g++ Transaccion.o Cliente.o NodoTransaccion.o NodoDecision.o ArbolTrasacciones.o ArbolDecision.o Sistema.o main.o -o programa
